        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          >
            ...
            <div style={{ flex: 1, textAlign: 'left' }}>
              ...
              <div style={{ fontSize: 12, color: '#8694A7' }}>Accéder à votre espace ambulancier</div>
            </div>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#B0BFCC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
